...
//    splitLayer.anchorPoint = CGPointMake(0, 0.5);
    ...
    splitLayer.backgroundColor = [[UIColor blueColor] CGColor];//[[UIColor colorWithHex:0xf3f3f3] CGColor];
...
- (void)willBackProgress{
    ...
    backLayer.backgroundColor = [[UIColor greenColor] CGColor];//[[UIColor colorWithHex:0xff5e5e] CGColor];
